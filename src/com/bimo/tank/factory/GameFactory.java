...
public abstract class GameFactory {
	public abstract BaseBullet createBullet(int x, int y, Direction dir,Group group);
	public abstract BaseTank createTank(int x, int y, int width, int height, Direction dir,Group group, int speed);
